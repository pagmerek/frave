...
impl Frave {
    ...
    pub fn get_pixel(&self, x: i32, y: i32) -> u32 {
        let Pixel { r, g: _, b: _ } = self.image.get_pixel(x as u32 % self.width, y as u32 % self.width); // we assume grayscale for now
        r as u32
    }
    ...
    // function used to illustrate how fractals are formed
